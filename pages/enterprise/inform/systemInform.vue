<template>
	<view>
		...
		<view class="content">
			<view class="body" v-for="(item, index) in systemInformArr" :key='index'>
				...
				<view class="body-detail">
					...
					<text class="body-detail-content-tips" v-else @click="viewReason">具体原因请点击>></text>
				</view>
			</view>
		</view>
		...
		<view class="dropList" v-if="dropListShow">
			...
			<text class="dropList-content">公司名称不正确，请核对无误后重新提交申请。公司名称不正确，请核对无误后重新提交申请。公司名称不正确，请核对无误后重新提交申请。</text>
