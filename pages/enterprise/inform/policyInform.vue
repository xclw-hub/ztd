<template>
	<view>
		...
		<view class="content">
			<view class="body" v-for="(item, index) in policyInformArr" :key='index'>
				...
				<view class="body-detail">
					...
					<text class="body-detail-deadline" v-if="item.deadline!=null">申请截至时间：{{item.deadline | timestampToTime}}</text>
					<text class="body-detail-option">查看详情>></text>
				</view>
			</view>
		</view>
	</view>
...
<style scoped>
	...
	.body-detail .body-detail-deadline{
		font-size: 28rpx;
		font-family: Source Han Sans CN;
		font-weight: 400;
		color: #666666;
