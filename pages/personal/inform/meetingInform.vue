		...
		<view class="content">
			<view class="body" v-for="(item, index) in meetingInformArr" :key='index'>
				...
				<view class="body-detail">
					...
					<text class="body-detail-content-tips" v-if="item.title==='会议取消'" @click="enterMeetingDetail">查看会议详情>></text>
					<text class="body-detail-content-tips" v-else @click="enterMeetingDetail">详情请点击>></text>
				</view>
			</view>
		</view>
	</view>
