...
export declare type DataZoomComponentOption = SliderDataZoomOption | InsideDataZoomOption;
export declare type VisualMapComponentOption = ContinousVisualMapOption | PiecewiseVisualMapOption;
export declare type LegendComponentOption = LegendOption | ScrollableLegendOption;
